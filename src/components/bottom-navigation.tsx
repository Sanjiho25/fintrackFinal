...
export function BottomNavigation() {
  ...
  React.useEffect(() => {
    ...
    if (currentNavItem) {
      ...
      if (pathname.startsWith('/profile') || pathname.startsWith('/monthly-reports') || pathname.startsWith('/categories') || pathname.startsWith('/notifications')) {
         setActiveTab("profile");
      }
      if (pathname.startsWith('/goal') || pathname.startsWith('/budget')) {
  ...
  if (['/login', '/register', '/goal', '/budget', '/monthly-reports', '/categories', '/learn/budgeting-guide', '/notifications'].includes(pathname)) {
    return null; 
  }
