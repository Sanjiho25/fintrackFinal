...
export function AddSavingGoalDialog({
  ...
  const [isTargetDatePickerOpen, setIsTargetDatePickerOpen] = React.useState(false);
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>Start Date</FormLabel>
                       <Dialog open={isStartDatePickerOpen} onOpenChange={setIsStartDatePickerOpen}>
                        ...
                        <DialogContent className="w-auto p-0">
                          <DialogHeader>
                            <DialogTitle className="sr-only">Select a start date</DialogTitle>
                          </DialogHeader>
                          <Calendar
                            mode="single"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      ...
                      <Dialog open={isTargetDatePickerOpen} onOpenChange={setIsTargetDatePickerOpen}>
                        <DialogTrigger asChild>
                          <FormControl>
                            <Button
                              variant={"outline"}
                        ...
                        <DialogContent className="w-auto p-0">
                           <DialogHeader>
                            <DialogTitle className="sr-only">Select a target date</DialogTitle>
                           </DialogHeader>
                           <Calendar
                            mode="single"
                            selected={field.value}
