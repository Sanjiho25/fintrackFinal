        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <section>
              ...
              <p className="text-sm text-muted-foreground">
                Where does your money go? Start logging every expense, big or small, using the "+" button in the app. Categorize them honestly (e.g., Groceries, Food &amp; Dining, Transport). This helps you see your spending patterns.
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mt-2">
                 <li>Start with essential needs (Groceries, Transport).</li>
